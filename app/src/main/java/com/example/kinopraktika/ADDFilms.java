...
public class ADDFilms extends AppCompatActivity {
    ...
    EditText tvName;
    ADDFilms.MyTask mt;
    ADDFilms.MyTaskN mtn;
    ADDFilms.MyTaskTF mttf;
    ListView lvMain;
    //    String ID;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addfilms);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
        lvMain = (ListView) findViewById(R.id.lvMain);
        lvMain.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
        mt = new ADDFilms.MyTask();
        mt.execute();

    }
    public void onclick(View v) {
        mtn = new ADDFilms.MyTaskN();
...
//        lvMain.getCheckedItemPositions();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                URL githubEndpoint = new URL("http://192.168.0.109/kino?id=3");
                myConnection =
            ...
            try {
                myConnection.getOutputStream().write( ("id=3&ID_kinoteatra=" + params[0]+"&ID_Film="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//                tvInfo.setText(str);
    ...
    class MyTaskN extends AsyncTask<String, Void, String >{
        ...
        protected String doInBackground(String... params) {
            ...
            HttpURLConnection myConnection=null;
            try {
                URL githubEndpoint = new URL("http://192.168.0.109//kino");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//            lvMain = (ListView) findViewById(R.id.lvMain);
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.secondaddapter, parent, false);
            };
